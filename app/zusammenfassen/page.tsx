...
import { ZusammenfassenBody, OpenAIModel } from '@/types/types';
import {
  Button,
  Flex,
  FormLabel,
...
export default function Home() {
  ...
  const handleTranslate = async () => {
    ...
    const maxCodeLength = model === 'gpt-4-1106-preview' ? 10000 : 10000;
    ...
    const body: ZusammenfassenBody = {
      content,
      model,
    };

    // -------------- Fetch --------------
    const response = await fetch('../api/zusammenfassenAPI', {
      method: 'POST',
      headers: {
      ...
      >
        ...
        >
          ...
          <Text fontSize={'16px'} color="gray.500" fontWeight="500" mb="30px">
            Den Text den du zusammenfassen willst.
          </Text>
          <Textarea
            border="1px solid"
            borderRadius={'10px'}
